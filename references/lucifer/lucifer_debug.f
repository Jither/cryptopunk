c     Modified version of Sorkin's LUCIFER for outputting
c     intermediate values.

      subroutine lucifer_debug(d,k,m)
...
c       Output round values and column headers
        print '(a6,i2,a5,i2)', 'Round ', ii, ', kc=',kc
        print 1000,'jj','l','h','v','kb','s0-L','s0-H','s1-L','s1-H'
...
c         jt: back up v for later output
          vb=v
...
c         Output intermediate values for each message byte
          print 1001,jj,l,h,vb,k(jj,ks),s0(l),s0(h),s1(l),s1(h),tr
...
1000  format((a4,a4,a4,a4,a4,a5,a5,a5,a5))
1001  format((i4,i4,i4,i4,i4,i5,i5,i5,i5)'  tr'16(1x,i1))
