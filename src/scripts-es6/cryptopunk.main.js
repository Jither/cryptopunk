...
import * as rotx from "./transforms/rotx";
...
import * as skip from "./transforms/skip";
import * as stringManipulation from "./transforms/string-manipulation";
import * as substitution from "./transforms/substitution";
import * as unicode from "./transforms/unicode";
import * as vigenere from "./transforms/vigenere";
...
addPaletteItem(sha256.Sha256Transform, "SHA-256", "SHA-256");
addPaletteItem(sha512.Sha384Transform, "SHA-384", "SHA-384");
addPaletteItem(sha512.Sha512Transform, "SHA-512", "SHA-512");
